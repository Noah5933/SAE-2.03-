...
> La configuration réseau par défaut est le **NAT**[^NAT], un réseau où la machine virtuelle a accès à Internet
...
> Les suppléments invités[^invit] sont des **pilotes adaptés aux systèmes invités** (Windows, GNU/Linux ...)
...
> 
> Le nom [Debian](http://fr.wikipedia.org/wiki/Debian ) provient d’une **concaténation** entre les parties des prénoms du créateur et sa petite amie de l’époque :
**==Ian== Murdock et ==Deb==ra Lynn → Deb Ian**.
